...
export const CHARACTERS = [
  {
    ...
    build: { torso: 'tapered', head: 'round', crest: 'visor', scale: 1.0, bulk: 1.0 },
  },
  {
    id: 'smash',
    name: 'Smash',
    ...
    build: { torso: 'blocky', head: 'square', crest: 'mohawk', scale: 1.08, bulk: 1.28 },
  },
  {
    id: 'zip',
    name: 'Zip',
    ...
    build: { torso: 'slim', head: 'round', crest: 'ponytail', scale: 0.94, bulk: 0.8 },
  },
  {
    id: 'pip',
    name: 'Pip',
    ...
    build: { torso: 'slim', head: 'round', crest: 'bun', scale: 0.9, bulk: 0.86 },
  },
  {
    id: 'bulwark',
    name: 'Bulwark',
    ...
    build: { torso: 'blocky', head: 'square', crest: 'cap', scale: 1.14, bulk: 1.35 },
  },
  {
    id: 'ace',
    name: 'Ace',
    ...
    build: { torso: 'tapered', head: 'round', crest: 'headband', scale: 0.99, bulk: 0.95 },
  },
];
